...
const uint16_t PROGMEM iron_b[] = {KC_R, KC_E, COMBO_END};
...
const uint16_t PROGMEM iron_j[] = {KC_S, KC_E, COMBO_END};
const uint16_t PROGMEM iron_k[] = {KC_T, KC_E, COMBO_END};
const uint16_t PROGMEM iron_l[] = {KC_N, KC_E, COMBO_END};
const uint16_t PROGMEM iron_m[] = {KC_A, KC_O, COMBO_END};
const uint16_t PROGMEM iron_p[] = {KC_I, KC_T, COMBO_END};
const uint16_t PROGMEM iron_q[] = {KC_T, KC_A, COMBO_END};
const uint16_t PROGMEM iron_u[] = {KC_I, KC_S, COMBO_END};
const uint16_t PROGMEM iron_v[] = {KC_R, KC_N, COMBO_END};
const uint16_t PROGMEM iron_w[] = {KC_T, KC_N, COMBO_END};
const uint16_t PROGMEM iron_x[] = {KC_S, KC_N, COMBO_END};
const uint16_t PROGMEM iron_y[] = {KC_N, KC_O, COMBO_END};
const uint16_t PROGMEM iron_z[] = {KC_R, KC_A, COMBO_END};
const uint16_t PROGMEM iron_A[] = {IR_SFT, KC_A, COMBO_END};
const uint16_t PROGMEM iron_B[] = {IR_SFT, KC_R, KC_E, COMBO_END};
...
const uint16_t PROGMEM iron_J[] = {IR_SFT, KC_S, KC_E, COMBO_END};
const uint16_t PROGMEM iron_K[] = {IR_SFT, KC_T, KC_E, COMBO_END};
const uint16_t PROGMEM iron_L[] = {IR_SFT, KC_N, KC_E, COMBO_END};
const uint16_t PROGMEM iron_M[] = {IR_SFT, KC_A, KC_T, COMBO_END};
...
const uint16_t PROGMEM iron_Q[] = {IR_SFT, KC_T, KC_A, COMBO_END};
...
const uint16_t PROGMEM iron_U[] = {IR_SFT, KC_I, KC_S, COMBO_END};
const uint16_t PROGMEM iron_V[] = {IR_SFT, KC_R, KC_N, COMBO_END};
const uint16_t PROGMEM iron_W[] = {IR_SFT, KC_T, KC_N, COMBO_END};
const uint16_t PROGMEM iron_X[] = {IR_SFT, KC_S, KC_N, COMBO_END};
const uint16_t PROGMEM iron_Y[] = {IR_SFT, KC_N, KC_O, COMBO_END};
const uint16_t PROGMEM iron_Z[] = {IR_SFT, KC_R, KC_A, COMBO_END};
const uint16_t PROGMEM iron_ctl[] = {KC_I, KC_S, KC_R, COMBO_END};
const uint16_t PROGMEM iron_alt[] = {KC_E, KC_A, KC_O, COMBO_END};
const uint16_t PROGMEM iron_com[] = {KC_S, KC_A, COMBO_END};
const uint16_t PROGMEM iron_dot[] = {KC_I, KC_O, COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_ISRT] = LAYOUT(
                   ...
                   KC_BSPC, LT(_MOUSE, KC_SPC), QK_GRAVE_ESCAPE, KC_NO, OSM(MOD_LGUI), IR_SFT, LT(_MOUSE, KC_TAB), KC_ENT
                   ),
  [_QWERTY] = LAYOUT(
